...
moveCmd = ['поезжай', 'сгоняй', 'доберись', 'переместись', 'приедь', 'прибудь', 'заедь', 'иди']
places = ['пункт NUM', 'кабинет NUM', 'отдел кадров', 'медпункт', 'библиотека']
objs = ['документ', 'чашка', 'работа', 'груз', 'объект', 'прибор']
actions = ['принеси', 'возьми', 'доставь', 'отвези', 'захвати']
please = ['пожалуйста', '']
dirF = ['туда']
dirB = ['оттуда', 'сюда']
back = ['и MOVE_CMD назад', 'и возвращайся']
