...
preposition = ['и','и затем','а затем','и потом', 'а потом', 'и после', 'а после', 'затем','потом','после','после этого','а после этого', 'и после этого','после чего','а после чего', 'и после чего', 'и только тогда', 'и только после этого', 'и только потом', 'и вот только тогда','и вот только затем']
places = ['кампус COUNTRY','пункт NUM', 'кабинет NUM', 'аудитория NUM', 'отдел кадров', 'медпункт', 'библиотека', 'пост охраны','буфет']
objs = ['аптечка','документ','инструмент','тетрадь','тетрадка','печать','блокнот','телефон','зонт','зонтик','документация','чашка','кружка','пенал','работа','груз','весы','объект','прибор','ножницы','яблоко','пицца','книга','книжка']
...
pril_1 = ['замечательный','талантливый','трудолюбивый','']
pril_2 = ['замечательная','талантливая','трудолюбивая','']
pril_3 = ['замечательные','талантливые','трудолюбивые','']

My1 = ['его', 'ее', 'их','мой','наш','твой','ваш','']
My2 = ['его','ее', 'их','моя','наша','твоя','ваша','']
My3 = ['его','ее', 'их','мои','наши','твои','ваши','']
I = ['я','']
He = ['он', 'она', 'MY_2 ADJECTIVE_2 группа','MY_1 ADJECTIVE_1 коллега','MY_2 ADJECTIVE_2 команда','MY_1 ADJECTIVE_1 состав', 'MY_1 ADJECTIVE_1 коллектив', 'NAME_1']
We = ['мы','']
They = ['они','MY_3 ADJECTIVE_3 коллеги', 'MY_3 ADJECTIVE_3 руководители','MY_3 ADJECTIVE_3 группы', 'NAME_3']
...
def generateSent(numSent):
    ...
    for i in range(numSent):
        template = sentTemplate[85]#random.randint(0, len(sentTemplate) - 1)] # random.randint(0, len(sentTemplate) - 1)
