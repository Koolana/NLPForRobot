...
objs = ['документ','тетрадь','блокнот','телефон','зонтик','документация','чашка','кружка','пенал','работа','груз','весы','объект','прибор','ножницы','яблоко','пицца']
actions = ['принеси','привези', 'отнеси', 'занеси', 'возьми', 'доставь', 'отвези', 'довези', 'захвати','прихвати', 'забери', 'передай']

action_there = ['принеси','привези', 'отнеси','отвези','занеси','возьми','доставь','довези','захвати','прихвати', 'забери', 'передай']
...
dir_only_here = ['сюда', 'для нас','для меня','нам','мне']
...
We = ['мы']
They = ['они']
Me = ['мне','ему','ей','нам', 'им']

I_want = ['хочу','желаю','прошу']
He_want = ['хочет','желает','просит']
We_want = ['хотим','желаем','просим']
They_want = ['хотят','желают','просят']
Me_want = ['хочется']
action_there_want = ['принес','привез', 'отнес','отвез','занес','взял','доставил','довез','захватил','прихватил', 'забрал', 'передал']
...
#  1, COM_I WANT_I чтобы ты WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ ONLY_HERE

# WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ
...
sentTemplate = [[0, 'BE_KIND MOVE_CMD в PLACE_1 и TH_ACT DIR_F OBJ'],           # 0
                ...
                [1, 'COM_I WANT_I чтобы ты WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ ONLY_HERE'],         # 56
                [0, 'COM_I WANT_I чтобы ты WANT_THEREACT OBJ в PLACE_1'],                                   # 57
                [2, 'COM_I WANT_I чтобы ты WANT_THEREACT OBJ в PLACE_1 WANT_BAC'],                          # 58
                [1, 'COM_HE WANT_HE чтобы ты WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ ONLY_HERE'],       # 59
                [0, 'COM_HE WANT_HE чтобы ты WANT_THEREACT OBJ в PLACE_1'],                                 # 60 
                [2, 'COM_HE WANT_HE чтобы ты WANT_THEREACT OBJ в PLACE_1 WANT_BAC'],                        # 61 
                [1, 'COM_WE WANT_WE чтобы ты WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ ONLY_HERE'],       # 62
                [0, 'COM_WE WANT_WE чтобы ты WANT_THEREACT OBJ в PLACE_1'],                                 # 63 
                [2, 'COM_WE WANT_WE чтобы ты WANT_THEREACT OBJ в PLACE_1 WANT_BAC'],                        # 64 
                [1, 'COM_ME WANT_ME чтобы ты WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ ONLY_HERE'],       # 65
                [0, 'COM_ME WANT_ME чтобы ты WANT_THEREACT OBJ в PLACE_1'],                                 # 66 
                [2, 'COM_ME WANT_ME чтобы ты WANT_THEREACT OBJ в PLACE_1 WANT_BAC'],                        # 67
                [1, 'COM_THEY WANT_THEY чтобы ты WANT_COM_MOVE в PLACE_1 и WANT_THEREACT OBJ ONLY_HERE'],   # 68
                [0, 'COM_THEY WANT_THEY чтобы ты WANT_THEREACT OBJ в PLACE_1'],                             # 69 
                [2, 'COM_THEY WANT_THEY чтобы ты WANT_THEREACT OBJ в PLACE_1 WANT_BAC']                     # 70
                ]   
